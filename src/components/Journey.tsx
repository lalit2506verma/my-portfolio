    ...
    >
      <div className="w-full max-w-200 flex flex-col gap-10">
        ...
        <div className="relative pl-6 md:pl-0">
          ...
          <div className="absolute left-3 top-0 bottom-0 w-0.5 bg-slate-200 h-full md:hidden"></div>
          <div className="absolute left-3 top-0 bottom-0 w-0.5 bg-linear-to-b from-primary/80 to-transparent h-full md:hidden blur-[1px]"></div>
          ...
          <div className="flex flex-col gap-12">
            {milestones.map((milestone, index) => (
              ...
              >
                <div
                  className={`absolute -left-3 md:left-1/2 md:-translate-x-1/2 bg-background-light p-1 rounded-full z-10 border-2 ${
                    index === 0
                      ? "border-primary shadow-[0_0_15px_rgba(19,146,236,0.5)]"
                  ...
                  <div
                    className={`${
                      index === 0
                        ...
                        : "bg-slate-100 text-slate-500 group-hover:text-primary group-hover:bg-primary/10"
                ...
                <div
                  className={`md:w-1/2 ${
                    milestone.isLeft ? "md:pl-12 pl-8" : "md:pr-12 pl-8 md:pl-0"
                  }`}
                >
                  <div className="glass-card p-5 md:p-6 rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-primary/5 hover:border-primary/30 group-hover:bg-white/80">
